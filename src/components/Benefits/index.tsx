        ...
        <div className="bg-white w-full h-auto flex flex-wrap items-center justify-evenly gap-20 md:gap-0">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="font-medium text-sm max-w-52 text-center">
              <Balancer>
                Canal de acesso a novos clientes em potencial, sem depender da
                estrutura interna do seu negócio.
              </Balancer>
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="font-medium text-sm max-w-56 text-center">
              <Balancer>
                Marketplace, vitrine virtual, campanhas de tráfego pago, mídias
                sociais e muito mais, para ajudar a alavancar suas vendas.
              </Balancer>
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="font-medium text-sm max-w-56 text-center">
              <Balancer>
                Consultoria de marketing, gestão contábil, assessoria jurídica e
                muito mais, para ajudar seu negócio a crescer cada vez mais.
              </Balancer>
            </p>
          </div>
        </div>
